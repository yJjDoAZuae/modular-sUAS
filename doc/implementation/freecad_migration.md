...
>
> **Blocked as of 2026-08-22 on OQ-DES-D2, which is about neither of those.**
> Section 3's completeness test names the dimensions a sheet must carry, and 6 of
> 22 interface parameters exist as a distance on their own part -- the rest are off
> by exactly a clearance, because the mating face already contains it. The partition,
> the factoring, the solver and the sheet pin are all done and none of them depend
> on the answer. What is blocked is which two points a dimension runs between.
