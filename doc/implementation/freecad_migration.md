...
| --- | --- | --- | --- | --- |
| IP-FC-1 | todo | Measure `freecadcmd` startup and single-part build time; the ratio decides subprocess-per-part vs long-lived worker vs multiprocessing | — | [freecad_migration.md §What must be preserved](../architecture/freecad_migration.md) |
