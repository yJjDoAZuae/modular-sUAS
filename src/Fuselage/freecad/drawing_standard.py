...
def table_rows_available(text_height_mm=None):
    ...
    Ten is not a comfortable number and should not be reported as one: packed
    abreast, every one of the thirteen families needs exactly 10. An eleventh row deepens
    the band past the budget
    and takes the view to 73.3 %.
    """
    height = TABLE_TEXT_HEIGHT_MM if text_height_mm is None else text_height_mm
